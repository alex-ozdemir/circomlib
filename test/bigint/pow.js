...
describe("PowerMod", () => {
    ...
    before(async () => {
        let cirDef = await compiler(path.join(__dirname, "..", "circuits", "bigint", "power_small.circom"));
        powmod_4_2_1 = new snarkjs.Circuit(cirDef);
        //let cirDef2 = await compiler(path.join(__dirname, "..", "circuits", "bigint", "power_2048_256.circom"));
